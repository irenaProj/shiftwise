    ...
    <div className="min-h-screen bg-gradient-to-br from-brand-900 via-brand-600 to-blue-400 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-blue-100 text-sm">AI-powered workforce scheduling</p>
        </div>

        {/* Card */}
        <div className="card p-8">
          <h1 className="text-xl font-semibold text-slate-900 mb-1">Welcome back</h1>
          <p className="text-slate-500 text-sm mb-6">Sign in to manage your team's schedule</p>
          ...
          <div className="mt-6 p-3 bg-slate-50 rounded-lg border border-slate-100">
            ...
            <p className="text-xs text-slate-600 font-mono">manager@demo.com / password123</p>
          </div>
        </div>
      </div>
    </div>
